...
import com.mingri.constant.AutoFillConstant;
...
public class AutoFillAspect {
    ...
    /**
     * 切入点（匹配mapper包下所有的类、方法以及参数类型,同时满足方法上加入了@AutoFill注解）
     */
    @Pointcut("execution(* com.mingri.mapper.*.*(..)) && @annotation(com.mingri.annotation.AutoFill)")
